    ...
    <x-slot:title>peminjaman</x-slot>
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Form peminjaman</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted" href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page">Form peminjaman</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <x-inputs.form class="form-peminjaman">
                    <div class="row">
                        ...
                        <div class="col-md-6 pt-3">
                            <div class="form-group">
                                <x-inputs.input type="date" id="name" name="jadwal" label="Jadwal"   />
                            </div>
                        </div>
                        <div class="col-md-6 pt-3">
                            <div class="form-group">
                                <x-inputs.input id="npm" name="npm" label="NPM"   />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="prasat-item">
                                ...
                                <div id="dynamicBarang-0" class="dynamic-barang">
                                    <div class="row mt-2 barang-item">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <x-inputs.select id="barang_id" name="barang_id[0][]" label="Barang / Alat" >
        ...
        <script>
                ...
                <div class="prasat-item">
                    ...
                    <div id="dynamicBarang-${prasatIndex}" class="dynamic-barang mt-4">
                        <div class="row mt-2 barang-item">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <x-inputs.select id="barang_id" name="barang_id[${prasatIndex}][]" label="Barang / Alat" >
                                        <option value="">Pilih Barang</option>
                                        @foreach ($barangs as $barang)
                                        <option value="{{ $barang->id }}">{{ $barang->nama_barang }}</option>
                                        @endforeach
            ...
            <div class="row mt-2 barang-item">
                <div class="col-md-5">
                    <div class="form-group">
                        <x-inputs.select id="barang_id" name="barang_id[${prasatId}][]" label="Barang / Alat" >
                            <option value="">Pilih Barang</option>
                            @foreach ($barangs as $barang)
                            <option value="{{ $barang->id }}">{{ $barang->nama_barang }}</option>
                            @endforeach
